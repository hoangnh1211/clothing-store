        ...
        if (datas!==undefined){
            result= datas.map((data,index)=>{
                ...
                if (data !== null){
                    ...
                    return(
                        <div className={this.state.new[index]} key={data.Link}> 
        ...
        return(
            <div className="new-top">
                ...
                <div id="carouselExampleInterval" className="carousel slide" data-ride="carousel">
                    ...
                    <div  className="a_prev" onClick={this.Back} >
                    <i className="fas fa-arrow-left  prev" onClick={this.Back} ></i>
                    </div>
                    <div className="a_next"  onClick={this.Next}>
                        <i className="fas fa-arrow-right next" onClick={this.Next}></i>
                    </div>
                </div>
            </div>
        )
